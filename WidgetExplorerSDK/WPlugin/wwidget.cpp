...
/// \param data
///
void WWidget::sendMessageCallback(WMetaData& data){
...
/// \param msg
///
void WWidget::receiveMessageCallback(WMetaData &msg){
    receiveMessage(msg);
}
///
...
bool WWidget::connectMessage(bool isConnect){
    return isConnect?connect(this,&WWidget::sendMessage,this, &WWidget::receiveMessageCallback):
               disconnect(this,&WWidget::sendMessage,this, &WWidget::receiveMessageCallback);
}
///
...
bool WWidget::setAttr(QString key,QVariant value){
    QVariant var;
    if(d->parent)var=d->parent->getWEClass()->widgetManager()->changeVariant(key,value);
